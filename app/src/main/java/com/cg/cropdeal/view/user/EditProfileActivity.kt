...
class EditProfileActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val profileImageRef = getSharedPreferences(
        ...
        when(v?.id){
            ...
            R.id.saveProfileButton ->{
                    ...
                    if(selectedImageFileUri != null) {
                        uploadImageToCloudStorage(selectedImageFileUri)
                    }
                    else{
    ...
    private fun uploadImageToCloudStorage(imageFileUri: Uri?) {
        val username = binding.editUserNameET.editText?.text.toString().trim{it<=' '}
        val dob = binding.editDobTV.text.toString().trim{it<=' '}
        val cars = binding.editCarsET.editText?.text.toString()
        viewModel.uploadImageToCloudStorage(imageFileUri,username,dob,cars)
    }
}